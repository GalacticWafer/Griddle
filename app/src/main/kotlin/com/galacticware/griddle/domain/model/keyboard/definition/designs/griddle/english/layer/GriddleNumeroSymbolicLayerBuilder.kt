...
import com.galacticware.griddle.domain.model.gesture.Gesture.Companion.simpleInput
...
object GriddleNumeroSymbolicLayerBuilder: GriddleLayerBuilder() {
    ...
    val button0 by lazy { builders.space2u.reposition(rowStart = 3, colStart = 1, colSpan = 1)
        .withGesture(simpleInput(CLICK, "0")) }
