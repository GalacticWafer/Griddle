    ...
    Text(
        ...
        onTextLayout = {
            if (it.didOverflowHeight && !readyToDraw) {
                val nextFontSizeValue = knownSize?: fontSizeValue - fontSizeRange.step.value
                ...
                appSymbol?.let { smb ->
                    PreferencesHelper.setAppSymbolSize(context, smb, fontSizeValue)
                }
            } else {
